...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Anuresha Interiors",
    "Anuresha Interior Private Limited",
    "Turnkey Interior Designer Pune",
    "Turnkey Interior Contractor PCMC",
    "Office Glass Partition Contractors Bhosari",
    "Office Glass Partition Contractors Hinjawadi",
    "Modular Furniture Manufacturer Baner",
    "Modular Furniture Manufacturer Wakad",
    "Modular Furniture Manufacturer Kothrud",
    "Commercial ACP Cladding Work Mumbai",
    "Commercial ACP Cladding Work Navi Mumbai",
    "Industrial Epoxy Flooring Chakan",
    "Industrial Epoxy Flooring Bhosari MIDC",
    "Property Maintenance Contractor Pune",
